...
function AiFreelancerCard({
  ...
  return (
    ...
    <div
      ...
      className="group relative overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 p-7 transition-all duration-500 hover:-translate-y-2 hover:border-blue-500/40 hover:shadow-2xl hover:shadow-blue-500/20"
    ...
    >
      ...
      <div className="mt-8 rounded-3xl border border-slate-800 bg-slate-950/60 p-6">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">
              ...
              Generated using skill similarity, experience and availability.
        ...
        <div className="space-y-5">
          ...
          />
              <div className="rounded-2xl border border-blue-500/20 bg-gradient-to-r from-blue-500/10 via-cyan-500/5 to-slate-900 p-5">
            ...
            <p className="mt-4 leading-7 text-slate-300">
              ...
              This freelancer is recommended because of a strong
              combination of technical skills, relevant experience,
              project compatibility and current availability.
              The recommendation engine predicts a
              <span className="font-semibold text-blue-400">
                {" "}
                {freelancer.overallScore}%{" "}
              </span>
              probability of successful project completion.
      ...
      <div className="mt-8">
        ...
        <button
          ...
          className="flex w-full items-center justify-between rounded-2xl border border-slate-800 bg-slate-950/60 px-5 py-4 transition-all duration-300 hover:border-blue-500/40 hover:bg-slate-900"
        ...
        {showReason && (
          ...
          <div className="mt-5 rounded-2xl border border-slate-800 bg-slate-950/60 p-6">
            ...
            <ul className="space-y-4">
              ...
              <li className="rounded-xl border border-blue-500/20 bg-blue-500/10 p-4 text-blue-300">
    ...
    onClick={() =>
        navigate(
            `/dashboard/freelancers/${freelancer.freelancerId}`
        )
    }
    className="
        mt-8
